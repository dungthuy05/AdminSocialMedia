  ...
  render() {
    return (
      <div className="topnav" style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <NavLink to="/" className="nav-button" strokeLinecap="active">
          <button>
            <svg
              width="40px"
              height="40px"
        ...
        <NavLink to="/post" className="nav-button" strokeLinecap="active">
          <button>
            <svg
              width="40px"
              height="40px"
        ...
        <NavLink to="/pendinguser" className="nav-button" strokeLinecap="active">
          <button>
            <svg
              width="40px"
              height="40px"
